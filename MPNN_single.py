...
from dgllife.model import SchNetPredictor, MPNNPredictor
...
model = MPNNPredictor(node_in_feats=74, node_out_feats=128, edge_hidden_feats=128, edge_in_feats=12, n_tasks=1)
...
for epoch in range(num_epochs):
    ...
    if test_roc_auc > best_accuracy:
        ...
        torch.save(best_model_state_dict, "MPNN_best_model.pt")
