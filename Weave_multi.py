...
model = WeavePredictor(node_in_feats=74, edge_in_feats=12, gnn_hidden_feats=64, graph_feats=64, num_gnn_layers=3, n_tasks=6)
...
for epoch in range(num_epochs):
    ...
    if test_roc_auc > best_accuracy:
        ...
        torch.save(best_model_state_dict, "Weave_multi_model.pt")
