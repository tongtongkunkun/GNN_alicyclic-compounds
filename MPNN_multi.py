...
model = MPNNPredictor(node_in_feats=74, node_out_feats=200, edge_hidden_feats=200, edge_in_feats=12, n_tasks=6)
...
for epoch in range(num_epochs):
    ...
    if test_roc_auc > best_accuracy:
        ...
        torch.save(best_model_state_dict, "MPNN_multi_model.pt")
