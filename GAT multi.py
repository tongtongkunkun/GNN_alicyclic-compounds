...
model = GATPredictor(in_feats=74, classifier_hidden_feats=200, n_tasks=6, predictor_hidden_feats=200)
...
for epoch in range(num_epochs):
    ...
    if test_roc_auc > best_accuracy:
        ...
        torch.save(best_model_state_dict, "GAT_multi_best_model.pt")
